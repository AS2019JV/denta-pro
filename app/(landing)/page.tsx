...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 font-text text-foreground">
        ...
        <div className="container px-4 md:px-6 relative">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tighter text-foreground font-title leading-[0.95] -ml-0.5">
                La clínica del 
              ...
              <p className="text-xl text-slate-500 leading-relaxed font-text max-w-lg mx-auto lg:mx-0 font-light tracking-tight">
                Gestión inteligente, historias clínicas y analíticas. <span className="text-foreground/90 font-medium">Todo en una sola plataforma.</span>
              </p>
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)] border border-white/40 bg-card/50 backdrop-blur-sm ring-1 ring-black/5 transition-all duration-500 hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.15)] hover:-translate-y-1 group">
                <img 
                ...
                <motion.div 
                  ...
                  className="absolute top-6 right-6 p-2 rounded-lg bg-card/80 backdrop-blur-md border border-white/50 shadow-md flex items-center gap-2"
                >
      ...
      <section id="contact" className="py-20 relative overflow-hidden">
        ...
        {/* Abstract shapes */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-card/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
